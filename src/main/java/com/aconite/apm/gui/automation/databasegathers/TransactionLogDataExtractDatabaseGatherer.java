...
//    TODO: TRXSTATUS=10 Token Delete needs to be included as it is in the transaction log data extract
    ...
    public void gatherData(int thisRunFromId)
    {
        try
        {
            ...
            preparedSelect.setInt(1, thisRunFromId + 1);
            preparedSelect.setInt(2, thisRunFromId + 1);
            preparedSelect.setInt(3, thisRunFromId + 1);
            preparedSelect.setInt(4, thisRunFromId + 1);

            System.out.println("About to gather data for transactionlogdataextract with ID = " + thisRunFromId + " ...");
            ...
            while (rs.next())
            {
                ...
                record.setSystemDateTime(rs.getString(5));
                record.setReqDateTime(rs.getString(6));
                ...
                record.setRspDateTime(rs.getString(40));
            ...
            System.out.println("Data gathered for all transactionlogdataextract entries with ID = " + thisRunFromId + ": " + rowCount + " rows found");
